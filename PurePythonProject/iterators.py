...
# Be careful, one more call to next() and this script will throw an exception!
...
# If you have no idea how many items can be safely accessed via the iterator,
...
input( '\n\nPress Enter to exit...' )
#def bar():
#    tasks = {'completed':u'0','name':u'qwe'}
#    tasks[]